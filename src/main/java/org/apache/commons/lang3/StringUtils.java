...
public class StringUtils {
     ...
     * @return an array of parsed Strings, {@code null} if null String input.
     */
    // REFACTORED: Delegates to the String overload's single-char path
    private static String[] splitWorker(final String str, final char separatorChar, final boolean preserveAllTokens) {
        return splitWorker(str, String.valueOf(separatorChar), -1, preserveAllTokens);
    }
     ...
     * @return an array of parsed Strings, {@code null} if null String input.
     */
    // REFACTORED: Original CC=23, reduced by extracting tokenization paths
    private static String[] splitWorker(final String str, final String separatorChars, final int max, final boolean preserveAllTokens) {
        ...
        // Dispatch to appropriate tokenization method based on separator type
        if (separatorChars == null) {
            return tokenizeByWhitespace(str, len, max, preserveAllTokens);
        } else if (separatorChars.length() == 1) {
            return tokenizeBySingleChar(str, len, separatorChars.charAt(0), max, preserveAllTokens);
        } else {
            return tokenizeByMultiChar(str, len, separatorChars, max, preserveAllTokens);
        }
    }

    /** Tokenizes by whitespace characters. */
    private static String[] tokenizeByWhitespace(final String str, final int len, final int max, final boolean preserveAllTokens) {
        final List<String> list = new ArrayList<>();
        int sizePlus1 = 1;
        int i = 0;
        int start = 0;
        ...
        return finalizeSplitResult(list, str, start, i, match, preserveAllTokens, lastMatch);
    }

    /** Tokenizes by a single character separator. */
    private static String[] tokenizeBySingleChar(final String str, final int len, final char sep, final int max, final boolean preserveAllTokens) {
        final List<String> list = new ArrayList<>();
        int sizePlus1 = 1;
        int i = 0;
        int start = 0;
    ...
    /** Tokenizes by multiple separator characters. */
    private static String[] tokenizeByMultiChar(final String str, final int len, final String separatorChars, final int max, final boolean preserveAllTokens) {
        final List<String> list = new ArrayList<>();
        int sizePlus1 = 1;
        int i = 0;
        int start = 0;
    ...
    /** Adds final token and returns result array. */
    private static String[] finalizeSplitResult(final List<String> list, final String str, final int start, final int end,
                                                 final boolean match, final boolean preserveAllTokens, final boolean lastMatch) {
